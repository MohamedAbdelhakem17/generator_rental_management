...
import { allocateExpense, createExpense, getExpense, listExpenses, updateExpense } from './expense.controller.js';
...
expenseRouter.patch('/expenses/:id', requirePermission('expenses:write'), asyncHandler(updateExpense));
expenseRouter.post('/expenses/:id/allocate', requirePermission('expenses:write'), asyncHandler(allocateExpense));
