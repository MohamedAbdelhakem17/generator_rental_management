...
const ROLES: Role[] = ['admin', 'ops_manager', 'finance_manager', 'accountant', 'technician', 'viewer'];
  ...
  return (
    <>
      <PageHeader
        ...
        description="TASK-004 preview — AppShell, RTL, and the shared primitives every later module builds on."
        action={
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuLabel>Preview as role (stands in for TASK-006 auth)</DropdownMenuLabel>
                <DropdownMenuSeparator />
