...
export const PERMISSION_GROUPS: { label: string; keys: PermissionKey[] }[] = [
  ...
  {
    label: 'Generators',
    keys: ['generators:read', 'generators:write', 'generators:override', 'generators:delete', 'generators:meterCorrection'],
  },
  { label: 'Customers', keys: ['customers:read', 'customers:write', 'customers:delete'] },
  { label: 'Projects', keys: ['projects:read', 'projects:write'] },
  { label: 'Contracts', keys: ['contracts:read', 'contracts:write'] },
  { label: 'Operations', keys: ['operations:read', 'operations:write'] },
